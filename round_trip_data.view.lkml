view: round_trip_data {
  derived_table: {
    sql: select
      ...
      and (
      date(adv.dt_added) between (current_date()-interval 20 day) and current_date()
      or date(oa.dt_added) between (current_date()-interval 20 day) and current_date()
      or date(ob.dt_added) between (current_date()-interval 20 day) and current_date()
      )
       ;;
  }
